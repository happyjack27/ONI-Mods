...
{
    class Base2x2EveryTickConfig : IBuildingConfig
    {
        public static string ID = "Base2x2EveryTick";
        public static string anim = "2x2base_kanim";

        public static LocString NAME = (LocString)"Test Every Tick";
        ...
        {
            go.AddOrGet<BaseLogicEveryTick>();

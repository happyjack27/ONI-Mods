...
namespace EdgeDetectors
{
    ...
    public abstract class UnaryGate : KMonoBehaviour, ILogicEventSender, ILogicNetworkConnection, IRenderEveryTick
    {

        [MyCmpAdd]
        protected CopyBuildingSettings copyBuildingSettings;

        protected static readonly EventSystem.IntraObjectHandler<UnaryGate> OnLogicValueChangedDelegate = new EventSystem.IntraObjectHandler<UnaryGate>((component, data) => component.OnLogicValueChanged(data));
        ...
        {
            base.OnPrefabInit();
            this.Subscribe<UnaryGate>(-905833192, (IntraObjectHandler<UnaryGate>)((comp, data) => comp.OnCopySettings(data)));
        }

        protected void OnCopySettings(object data)
        {
            UnaryGate component = ((GameObject)data).GetComponent<UnaryGate>();
        ...
        {
            base.OnSpawn();
            this.Subscribe<UnaryGate>(-801688580, UnaryGate.OnLogicValueChangedDelegate);
        ...
        protected void Connect()
        {
            ...
            int outputCellOne = this.ports.GetPortCell(UnaryGateConfig.OUTPUT_PORT_ID);
        ...
        public int GetInputValue()
        {
            ...
            return component?.GetInputValue(UnaryGateConfig.INPUT_PORT_ID) ?? 0;
        }

        public int GetOutputValue()
        {
            LogicPorts component = this.GetComponent<LogicPorts>();
            return component?.GetOutputValue(UnaryGateConfig.OUTPUT_PORT_ID) ?? 0;
        }
        ...
        protected LogicCircuitNetwork GetInputNetwork()
        {
            ...
            if ((UnityEngine.Object)this.ports != (UnityEngine.Object)null)
                logicCircuitNetwork = Game.Instance.logicCircuitManager.GetNetworkForCell(this.ports.GetPortCell(UnaryGateConfig.INPUT_PORT_ID));
        ...
        protected LogicCircuitNetwork GetOutputNetwork()
        {
            ...
            if (this.ports != null)
                logicCircuitNetwork = Game.Instance.logicCircuitManager.GetNetworkForCell(this.ports.GetPortCell(UnaryGateConfig.OUTPUT_PORT_ID));
            return logicCircuitNetwork;
        }
        ...
        {
            return this.ports.GetPortCell(UnaryGateConfig.OUTPUT_PORT_ID);
        }
        ...
        protected void UpdateVisuals(int inputVal, int outputValue)
        {
            int num = inputVal + outputValue * 4;

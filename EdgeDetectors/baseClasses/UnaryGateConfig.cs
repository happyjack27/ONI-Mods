...
{
    public abstract class UnaryGateConfig : IBuildingConfig
    {
        public static string anim = "logic_unary_kanim";

        public static LocString NAME = (LocString)"UnaryGate";
        ...
        )
        {
            ...
            buildingDef.LogicOutputPorts = new List<LogicPorts.Port>() {
                new LogicPorts.Port(
                    UnaryGateConfig.OUTPUT_PORT_ID,
                    new CellOffset(1, 0),

...
public class LogicPorts : KMonoBehaviour, IGameObjectEffectDescriptor, IRenderEveryTick
{
  ...
  protected override void OnSpawn()
  {
    ...
    if ((this.isPhysical ? 0 : ((UnityEngine.Object) this.GetComponent<BuildingUnderConstruction>() == (UnityEngine.Object) null ? 1 : 0)) != 0)
    {
  ...
  private void CreatePhysicalPorts(bool forceCreate = false)
  {
    ...
    if (this.outputPortInfo != null)
    {
      ...
      for (int index = 0; index < this.outputPortInfo.Length; ++index)
      {
        ...
        LogicEventSender elem = new LogicEventSender(info.id, this.GetActualCell(info.cellOffset), (System.Action<int>) (new_value =>
        {
    ...
    for (int index = 0; index < this.inputPortInfo.Length; ++index)
    {
      ...
      LogicEventHandler elem = new LogicEventHandler(this.GetActualCell(info.cellOffset), (System.Action<int>) (new_value =>
      {
        if (!((UnityEngine.Object) this != (UnityEngine.Object) null))
          return;
        this.OnLogicValueChanged(info.id, new_value);
  ...
  private void UpdateMissingWireIcon() => LogicCircuitManager.ToggleNoWireConnected(this.ShowMissingWireIcon(), this.gameObject);

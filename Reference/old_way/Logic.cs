...
namespace SomeLogicGates
{
    ...
    public class Logic : LogicBase, ILogicEventSender, ILogicNetworkConnection
    {
        private static readonly Logic.LogicGateDescriptions.Description INPUT_ONE_SINGLE_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description INPUT_ONE_MULTI_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description INPUT_TWO_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description INPUT_THREE_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description INPUT_FOUR_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description OUTPUT_ONE_SINGLE_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description OUTPUT_ONE_MULTI_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description OUTPUT_TWO_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description OUTPUT_THREE_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description OUTPUT_FOUR_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description CONTROL_ONE_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private static readonly Logic.LogicGateDescriptions.Description CONTROL_TWO_DESCRIPTION = new Logic.LogicGateDescriptions.Description()
        {
        ...
        private Logic.LogicGateDescriptions descriptions;
        ...
        private static readonly EventSystem.IntraObjectHandler<Logic> OnBuildingBrokenDelegate = new EventSystem.IntraObjectHandler<Logic>((System.Action<Logic, object>)((component, data) => component.OnBuildingBroken(data)));
        private static readonly EventSystem.IntraObjectHandler<Logic> OnBuildingFullyRepairedDelegate = new EventSystem.IntraObjectHandler<Logic>((System.Action<Logic, object>)((component, data) => component.OnBuildingFullyRepaired(data)));
    ...
    {
      Logic.LINE_LEFT_1_SYMBOL_BLOOM,
      Logic.FLIPPER_1_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_1_SYMBOL_BLOOM,
      Logic.FLIPPER_3_SYMBOL_BLOOM,
      Logic.OUTPUT_SYMBOL_BLOOM
    },
    new KAnimHashedString[5]
    {
      Logic.LINE_LEFT_2_SYMBOL_BLOOM,
      Logic.FLIPPER_1_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_1_SYMBOL_BLOOM,
      Logic.FLIPPER_3_SYMBOL_BLOOM,
      Logic.OUTPUT_SYMBOL_BLOOM
    ...
    new KAnimHashedString[5]
    {
      Logic.LINE_LEFT_3_SYMBOL_BLOOM,
      Logic.FLIPPER_2_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_2_SYMBOL_BLOOM,
      Logic.FLIPPER_3_SYMBOL_BLOOM,
      Logic.OUTPUT_SYMBOL_BLOOM
    },
    new KAnimHashedString[5]
    {
      Logic.LINE_LEFT_4_SYMBOL_BLOOM,
      Logic.FLIPPER_2_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_2_SYMBOL_BLOOM,
      Logic.FLIPPER_3_SYMBOL_BLOOM,
      Logic.OUTPUT_SYMBOL_BLOOM
        ...
        {
    Logic.LINE_LEFT_1_SYMBOL,
    Logic.LINE_LEFT_2_SYMBOL,
    Logic.LINE_LEFT_3_SYMBOL,
    Logic.LINE_LEFT_4_SYMBOL,
    Logic.LINE_RIGHT_1_SYMBOL,
    Logic.LINE_RIGHT_2_SYMBOL,
    Logic.FLIPPER_1_SYMBOL,
    Logic.FLIPPER_2_SYMBOL,
    Logic.FLIPPER_3_SYMBOL,
    Logic.OUTPUT_SYMBOL
        };
    ...
    {
      Logic.INPUT_SYMBOL_BLOOM,
      Logic.LINE_LEFT_1_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_1_SYMBOL_BLOOM,
      Logic.OUTPUT1_SYMBOL
    },
    new KAnimHashedString[4]
    {
      Logic.INPUT_SYMBOL_BLOOM,
      Logic.LINE_LEFT_1_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_2_SYMBOL_BLOOM,
      Logic.OUTPUT2_SYMBOL
    },
    new KAnimHashedString[4]
    {
      Logic.INPUT_SYMBOL_BLOOM,
      Logic.LINE_LEFT_2_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_3_SYMBOL_BLOOM,
      Logic.OUTPUT3_SYMBOL
    },
    new KAnimHashedString[4]
    {
      Logic.INPUT_SYMBOL_BLOOM,
      Logic.LINE_LEFT_2_SYMBOL_BLOOM,
      Logic.LINE_RIGHT_4_SYMBOL_BLOOM,
      Logic.OUTPUT4_SYMBOL
    }
        };
    ...
    Logic.LINE_RIGHT_1_SYMBOL,
    Logic.LINE_RIGHT_2_SYMBOL,
    Logic.LINE_RIGHT_3_SYMBOL,
    Logic.LINE_RIGHT_4_SYMBOL
        };
    ...
    Logic.OUTPUT4_SYMBOL
        ...
        {
    Logic.OUTPUT1_SYMBOL_BLM_RED,
    Logic.OUTPUT2_SYMBOL_BLM_RED,
    Logic.OUTPUT3_SYMBOL_BLM_RED,
    Logic.OUTPUT4_SYMBOL_BLM_RED
        };
        private static KAnimHashedString[] demultiplexerOutputGreenSymbols = new KAnimHashedString[4]
        {
    Logic.OUTPUT1_SYMBOL_BLM_GRN,
    Logic.OUTPUT2_SYMBOL_BLM_GRN,
    Logic.OUTPUT3_SYMBOL_BLM_GRN,
    Logic.OUTPUT4_SYMBOL_BLM_GRN
        };
        ...
        protected override void OnSpawn()
        {
            ...
            if (this.RequiresFourOutputs)
            {
                ...
                this.outputTwoSender = new LogicEventSender(LogicBase.OUTPUT_TWO_PORT_ID, this.OutputCellTwo, (System.Action<int>)(new_value =>
               {
                   if (!((UnityEngine.Object)this != (UnityEngine.Object)null))
                       return;
                   this.OnAdditionalOutputsLogicValueChanged(LogicBase.OUTPUT_TWO_PORT_ID, new_value);
               }), (System.Action<int, bool>)null, LogicPortSpriteType.Output);
                this.outputThreeSender = new LogicEventSender(LogicBase.OUTPUT_THREE_PORT_ID, this.OutputCellThree, (System.Action<int>)(new_value =>
               {
                   if (!((UnityEngine.Object)this != (UnityEngine.Object)null))
                       return;
                   this.OnAdditionalOutputsLogicValueChanged(LogicBase.OUTPUT_THREE_PORT_ID, new_value);
               }), (System.Action<int, bool>)null, LogicPortSpriteType.Output);
                this.outputFourSender = new LogicEventSender(LogicBase.OUTPUT_FOUR_PORT_ID, this.OutputCellFour, (System.Action<int>)(new_value =>
               {
                   if (!((UnityEngine.Object)this != (UnityEngine.Object)null))
                       return;
                   this.OnAdditionalOutputsLogicValueChanged(LogicBase.OUTPUT_FOUR_PORT_ID, new_value);
               }), (System.Action<int, bool>)null, LogicPortSpriteType.Output);
            }
            this.Subscribe<Logic>(774203113, Logic.OnBuildingBrokenDelegate);
            this.Subscribe<Logic>(-1735440190, Logic.OnBuildingFullyRepairedDelegate);
        ...
        protected override void OnCleanUp()
        {
            ...
            this.Disconnect();
            this.Unsubscribe<Logic>(774203113, Logic.OnBuildingBrokenDelegate);
            this.Unsubscribe<Logic>(-1735440190, Logic.OnBuildingFullyRepairedDelegate);
            base.OnCleanUp();
        }
        ...
        public int GetPortValue(LogicBase.PortId port)
        {
            switch (port)
            {
        ...
        public bool GetPortConnected(LogicBase.PortId port) => (port != LogicBase.PortId.InputTwo || this.RequiresTwoInputs || this.RequiresFourInputs) && (port != LogicBase.PortId.InputThree || this.RequiresFourInputs) && (port != LogicBase.PortId.InputFour || this.RequiresFourInputs) && Game.Instance.logicCircuitManager.GetNetworkForCell(this.PortCell(port)) != null;

        public void SetPortDescriptions(Logic.LogicGateDescriptions descriptions) => this.descriptions = descriptions;

        public Logic.LogicGateDescriptions.Description GetPortDescription(
          LogicBase.PortId port)
        {
            switch (port)
            {
                case LogicBase.PortId.InputOne:
                    ...
                    return !this.RequiresTwoInputs && !this.RequiresFourInputs ? Logic.INPUT_ONE_SINGLE_DESCRIPTION : Logic.INPUT_ONE_MULTI_DESCRIPTION;
                case LogicBase.PortId.InputTwo:
                    return this.descriptions.inputTwo == null ? Logic.INPUT_TWO_DESCRIPTION : this.descriptions.inputTwo;
                case LogicBase.PortId.InputThree:
                    return this.descriptions.inputThree == null ? Logic.INPUT_THREE_DESCRIPTION : this.descriptions.inputThree;
                case LogicBase.PortId.InputFour:
                    return this.descriptions.inputFour == null ? Logic.INPUT_FOUR_DESCRIPTION : this.descriptions.inputFour;
                case LogicBase.PortId.OutputOne:
                    if (this.descriptions.inputOne != null)
                        return this.descriptions.inputOne;
                    return !this.RequiresFourOutputs ? Logic.OUTPUT_ONE_SINGLE_DESCRIPTION : Logic.OUTPUT_ONE_MULTI_DESCRIPTION;
                case LogicBase.PortId.OutputTwo:
                    return this.descriptions.outputTwo == null ? Logic.OUTPUT_TWO_DESCRIPTION : this.descriptions.outputTwo;
                case LogicBase.PortId.OutputThree:
                    return this.descriptions.outputThree == null ? Logic.OUTPUT_THREE_DESCRIPTION : this.descriptions.outputThree;
                case LogicBase.PortId.OutputFour:
                    return this.descriptions.outputFour == null ? Logic.OUTPUT_FOUR_DESCRIPTION : this.descriptions.outputFour;
                case LogicBase.PortId.ControlOne:
                    return this.descriptions.controlOne == null ? Logic.CONTROL_ONE_DESCRIPTION : this.descriptions.controlOne;
                case LogicBase.PortId.ControlTwo:
                    return this.descriptions.controlTwo == null ? Logic.CONTROL_TWO_DESCRIPTION : this.descriptions.controlTwo;
                default:
        ...
        protected void RefreshAnimation()
        {
            ...
            if (this.op == LogicGateBase.Op.Multiplexer)
            {
                ...
                KAnimHashedString[] multiplexerSymbolPath = Logic.multiplexerSymbolPaths[val];
                ...
                this.ShowSymbolConditionally(networkForCell2 != null, this.inputOne.Value == 0, component, Logic.INPUT1_SYMBOL_BLM_RED, Logic.INPUT1_SYMBOL_BLM_GRN);
                this.ShowSymbolConditionally(networkForCell3 != null, this.inputTwo.Value == 0, component, Logic.INPUT2_SYMBOL_BLM_RED, Logic.INPUT2_SYMBOL_BLM_GRN);
                this.ShowSymbolConditionally(networkForCell4 != null, this.inputThree.Value == 0, component, Logic.INPUT3_SYMBOL_BLM_RED, Logic.INPUT3_SYMBOL_BLM_GRN);
                this.ShowSymbolConditionally(networkForCell5 != null, this.inputFour.Value == 0, component, Logic.INPUT4_SYMBOL_BLM_RED, Logic.INPUT4_SYMBOL_BLM_GRN);
                this.ShowSymbolConditionally(networkForCell1 != null, fromControlValue.Value == 0, component, Logic.OUTPUT1_SYMBOL_BLM_RED, Logic.OUTPUT1_SYMBOL_BLM_GRN);
                this.TintSymbolConditionally(networkForCell2 != null, this.inputOne.Value == 0, component, Logic.INPUT1_SYMBOL, this.inactiveTintColor, this.activeTintColor);
                this.TintSymbolConditionally(networkForCell3 != null, this.inputTwo.Value == 0, component, Logic.INPUT2_SYMBOL, this.inactiveTintColor, this.activeTintColor);
                this.TintSymbolConditionally(networkForCell4 != null, this.inputThree.Value == 0, component, Logic.INPUT3_SYMBOL, this.inactiveTintColor, this.activeTintColor);
                this.TintSymbolConditionally(networkForCell5 != null, this.inputFour.Value == 0, component, Logic.INPUT4_SYMBOL, this.inactiveTintColor, this.activeTintColor);
                this.TintSymbolConditionally(Game.Instance.logicCircuitSystem.GetNetworkForCell(this.OutputCellOne) != null && networkForCell1 != null, fromControlValue.Value == 0, component, Logic.OUTPUT1_SYMBOL, this.inactiveTintColor, this.activeTintColor);
                for (int index = 0; index < Logic.multiplexerSymbols.Length; ++index)
                {
                    KAnimHashedString multiplexerSymbol = Logic.multiplexerSymbols[index];
                    KAnimHashedString multiplexerBloomSymbol = Logic.multiplexerBloomSymbols[index];
            ...
            else if (this.op == LogicGateBase.Op.Demultiplexer)
            {
                ...
                KAnimHashedString[] demultiplexerSymbolPath = Logic.demultiplexerSymbolPaths[index1];
                ...
                for (int index2 = 0; index2 < Logic.demultiplexerSymbols.Length; ++index2)
                {
                    KAnimHashedString demultiplexerSymbol = Logic.demultiplexerSymbols[index2];
                    KAnimHashedString demultiplexerBloomSymbol = Logic.demultiplexerBloomSymbols[index2];
                ...
                this.ShowSymbolConditionally(networkForCell6 != null, this.inputOne.Value == 0, component, Logic.INPUT1_SYMBOL_BLM_RED, Logic.INPUT1_SYMBOL_BLM_GRN);
                if (networkForCell6 != null)
                    component.SetSymbolTint(Logic.INPUT1_SYMBOL_BLOOM, this.inputOne.Value == 0 ? this.inactiveTintColor : this.activeTintColor);
        ...
        this.OutputCellFour
                ...
                for (int index3 = 0; index3 < Logic.demultiplexerOutputSymbols.Length; ++index3)
                {
                    KAnimHashedString demultiplexerOutputSymbol = Logic.demultiplexerOutputSymbols[index3];
                    ...
                    this.ShowSymbolConditionally(networkForCell6 != null && networkForCell7 != null, flag, component, Logic.demultiplexerOutputRedSymbols[index3], Logic.demultiplexerOutputGreenSymbols[index3]);
                }
            }
        ...
        {
            public Logic.LogicGateDescriptions.Description inputOne;
            public Logic.LogicGateDescriptions.Description inputTwo;
            public Logic.LogicGateDescriptions.Description inputThree;
            public Logic.LogicGateDescriptions.Description inputFour;
            public Logic.LogicGateDescriptions.Description outputOne;
            public Logic.LogicGateDescriptions.Description outputTwo;
            public Logic.LogicGateDescriptions.Description outputThree;
            public Logic.LogicGateDescriptions.Description outputFour;
            public Logic.LogicGateDescriptions.Description controlOne;
            public Logic.LogicGateDescriptions.Description controlTwo;

...
{
    public abstract class LogicGateBaseConfig2 : IBuildingConfig
    {
          ...
          int height = 2)
        {
            ...
            LogicGateBase2.uiSrcData = Assets.instance.logicModeUIData;
        ...
        protected abstract LogicGate2.LogicGateDescriptions GetDescriptions();
        ...
        {
            LogicGate2 logicGate = go.AddComponent<LogicGate2>();
            ...
            go.GetComponent<KPrefabID>().prefabInitFn += (KPrefabID.PrefabFn)(game_object => game_object.GetComponent<LogicGate2>().SetPortDescriptions(this.GetDescriptions()));

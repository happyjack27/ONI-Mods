...
{
    public class LogicGateDiodeStrings
    {
        public static LocString NAME = (LocString)STRINGS.UI.FormatAsLink("Diode", nameof(LogicGateDiode));
        public static LocString DESC = (LocString)$"Automation signal only goes one way.";
        public static LocString EFFECT = (LocString)($"Automation signal only goes one way.");
        /*
